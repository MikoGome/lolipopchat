...
function character_choose (element) {
  ...
  document.getElementById("paimon").click();
  document.getElementsByTagName('body')[0].style.cursor= "url(/images/ice_cursor.png) 2 8, auto;"
  document.getElementsByTagName('body')[0].style.cursor= "url(/images/ice_cursor.png) 2 8, text;"
}
