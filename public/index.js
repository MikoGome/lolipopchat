...
function character_choose (element) {
  ...
  document.getElementById("paimon").click();
  window.getComputedStyle(document.getElementsByTagName('body')[0].style.cursor) = "url(/images/ice_cursor.png) 2 8, auto;"
  window.getComputedStyle(document.getElementsByTagName('body')[0].style.cursor) = "url(/images/ice_cursor.png) 2 8, text;"
}
...
function mochiVoice () {
  ...
  voicesMochi[randomSave2].currentTime = 0;
